...
final isYuanxiaoFestival = () {
  final is2026YuanXiao = inRange(DateTime(2027, 2, 20), DateTime(2027, 2, 20));
...
// 判断是否是38时段
final is38Festival = () {
  final is202638 = inRange(DateTime(2026, 3, 8), DateTime(2026, 3, 8));
  final is202738 = inRange(DateTime(2027, 3, 8), DateTime(2027, 3, 8));
  return is202638 || is202738;
}();
// 获取当前的背景图
