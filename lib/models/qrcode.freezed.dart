...
abstract class $QrcodeCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? type, String? code});
}
...
class _$QrcodeImpl implements _Qrcode {
  const _$QrcodeImpl({this.id, this.type, this.code});
  ...
  @override
  String toString() {
    return 'Qrcode(id: $id, type: $type, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, type, code);
...
abstract class _Qrcode implements Qrcode {
  const factory _Qrcode(
      {final int? id, final String? type, final String? code}) = _$QrcodeImpl;
