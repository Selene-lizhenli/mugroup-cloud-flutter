...
class SupplySupplierContactPage extends HookConsumerWidget {
  final int supplierId;
  const SupplySupplierContactPage({super.key, required this.supplierId});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      () async {
        try {
          final resp = await getSupplySupplierContacts(supplierId);
              ...
              child: InkWell(
                onTap: () async {
                  await context.router.push(
                      SupplySupplierContactCreateRoute(supplierId: supplierId));
                },
                child: Padding(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  if (c.id != null) {
                                    await context.router.push(
                                      SupplySupplierContactEditRoute(id: c.id!),
                                    );
                                  }
                                },
                                child: const Icon(
