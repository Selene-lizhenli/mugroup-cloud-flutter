...
class MarketProductCompanyCreateRoute extends _i56.PageRouteInfo<void> {
  const MarketProductCompanyCreateRoute({List<_i56.PageRouteInfo>? children})
      : super(
...
class MarketProductSupplierCreateRoute extends _i56.PageRouteInfo<void> {
  const MarketProductSupplierCreateRoute({List<_i56.PageRouteInfo>? children})
      : super(
...
class ShowroomSampleCreateRoute extends _i56.PageRouteInfo<void> {
  const ShowroomSampleCreateRoute({List<_i56.PageRouteInfo>? children})
      : super(
  ...
  static _i56.PageInfo page = _i56.PageInfo(
    name,
    builder: (data) {
      return const _i38.ShowroomSampleCreatePage();
    },
  );
}
