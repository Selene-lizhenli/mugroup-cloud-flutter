...
import 'package:cloud/models/wms/warehouse.dart' as _i19;
import 'package:cloud/pages/cart/cart_page.dart' as _i1;
import 'package:cloud/pages/cart/confirm/confirm_page.dart' as _i2;
import 'package:cloud/pages/cart/models/state.dart' as _i18;
import 'package:cloud/pages/crm/crm_company/crm_company_create/crm_company_create_page.dart'
    as _i3;
import 'package:cloud/pages/home/home_page.dart' as _i4;
import 'package:cloud/pages/layout.dart' as _i5;
import 'package:cloud/pages/login/login_page.dart' as _i6;
import 'package:cloud/pages/my/my_page.dart' as _i7;
import 'package:cloud/pages/scan/scan_page.dart' as _i8;
import 'package:cloud/pages/selectors/select_user/select_user_page.dart' as _i9;
...
import 'package:cloud/pages/selectors/select_wms_warehouse/select_wms_warehouse_page.dart'
    as _i11;
import 'package:cloud/pages/showroom/showroom_quotations_page.dart' as _i12;
import 'package:cloud/pages/showroom/showroom_sample/showroom_sample_detail/showroom_sample_detail_page.dart'
    as _i13;
import 'package:cloud/pages/wms/wms_delivery_page.dart' as _i14;
import 'package:cloud/pages/wms/wms_transfer_confirm/wms_transfer_confirm_page.dart'
    as _i15;
import 'package:cloud/pages/wms/wms_transfer_page.dart' as _i16;
...
/// generated route for
/// [_i2.ConfirmPage]
class ConfirmRoute extends _i17.PageRouteInfo<ConfirmRouteArgs> {
  ConfirmRoute({
    required List<_i18.CartItem>? items,
    required _i19.Warehouse? warehouse,
    _i20.Key? key,
...
class ConfirmRouteArgs {
  ...
  final List<_i18.CartItem>? items;

  final _i19.Warehouse? warehouse;
...
class CrmCompanyCreateRoute extends _i17.PageRouteInfo<void> {
  const CrmCompanyCreateRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i5.Layout]
class Layout extends _i17.PageRouteInfo<void> {
  const Layout({List<_i17.PageRouteInfo>? children})
      : super(
          Layout.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i7.MyPage]
class MyRoute extends _i17.PageRouteInfo<void> {
  const MyRoute({List<_i17.PageRouteInfo>? children})
      : super(
          MyRoute.name,
          initialChildren: children,
        );
...
class SelectUserRoute extends _i17.PageRouteInfo<void> {
  const SelectUserRoute({List<_i17.PageRouteInfo>? children})
      : super(
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i9.SelectUserPage();
    },
  );
}

/// generated route for
/// [_i10.SelectWmsBorrowPage]
class SelectWmsBorrowRoute extends _i17.PageRouteInfo<void> {
  const SelectWmsBorrowRoute({List<_i17.PageRouteInfo>? children})
      : super(
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i10.SelectWmsBorrowPage();
    },
  );
}

/// generated route for
/// [_i11.SelectWmsWarehousePage]
class SelectWmsWarehouseRoute extends _i17.PageRouteInfo<void> {
  const SelectWmsWarehouseRoute({List<_i17.PageRouteInfo>? children})
      : super(
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i11.SelectWmsWarehousePage();
    },
  );
}

/// generated route for
/// [_i12.ShowroomQuotationsPage]
class ShowroomQuotationsRoute
    extends _i17.PageRouteInfo<ShowroomQuotationsRouteArgs> {
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    ...
    builder: (data) {
      ...
      return _i12.ShowroomQuotationsPage(
        key: args.key,
...
/// generated route for
/// [_i13.ShowroomSampleDetailPage]
class ShowroomSampleDetailRoute
    extends _i17.PageRouteInfo<ShowroomSampleDetailRouteArgs> {
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    ...
    builder: (data) {
      ...
      return _i13.ShowroomSampleDetailPage(
        key: args.key,
        id: args.id,
      );
    },
...
/// generated route for
/// [_i14.WmsDeliveryPage]
class WmsDeliveryRoute extends _i17.PageRouteInfo<WmsDeliveryRouteArgs> {
  WmsDeliveryRoute({
    _i20.Key? key,
...
/// generated route for
/// [_i15.WmsTransferConfirmPage]
class WmsTransferConfirmRoute
    extends _i17.PageRouteInfo<WmsTransferConfirmRouteArgs> {
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    ...
    builder: (data) {
      ...
      return _i15.WmsTransferConfirmPage(
        key: args.key,
        id: args.id,
      );
    },
...
/// generated route for
/// [_i16.WmsTransferPage]
class WmsTransferRoute extends _i17.PageRouteInfo<WmsTransferRouteArgs> {
  WmsTransferRoute({
    _i20.Key? key,
    required String code,
    List<_i17.PageRouteInfo>? children,
